...
import { Image, ImageContainer, CarouselContainer, ImageLink, ImageLinkContainer } from "../../Styles/Image.Styled";
    ...
    <CarouselContainer id="carousel" className="carousel slide">
      ...
      <ImageContainer className="carousel-inner">
        <div className="carousel-item active">
          ...
          <ImageLinkContainer className="bg-dark carousel-caption d-none d-md-block">
